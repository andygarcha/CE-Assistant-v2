...
@pytest.fixture(scope="module")
def by_name(all_rolls: list[CERoll]):
...
def _wrong_count(rolls: list[CERoll], expected: int) -> list:
    return [r for r in rolls if len(r.games) != expected]


def _out_of_range(rolls: list[CERoll], lo: int, hi: int) -> list:
...
def _rolls_won(rolls) -> list:
    return [r for r in rolls if r.status == "won"]


def _rolls_active(rolls) -> list:
...
class TestStructural:
    ...
    def test_no_roll_has_zero_games(self, all_rolls):
    ...
    def test_roll_status_values_are_valid(self, all_rolls):
        valid = {
            "current",
            "won",
            "failed",
...
class TestSoloRollGameCounts:
    def test_one_hell_of_a_day_has_one_game(self, by_name):
    ...
    def test_one_hell_of_a_week_has_five_games(self, by_name):
    ...
    def test_one_hell_of_a_month_has_25_games(self, by_name):
    ...
    def test_never_lucky_has_one_game(self, by_name):
    ...
    def test_triple_threat_has_three_games(self, by_name):
    ...
    def test_let_fate_decide_has_one_game(self, by_name):
    ...
    def test_two_week_t2_streak_game_count_in_range(self, by_name):
    ...
    def test_two_week_t2_streak_won_has_two_games(self, by_name):
    ...
    def test_two_two_week_t2_streak_streak_game_count_in_range(self, by_name):
    ...
    def test_two_two_week_t2_streak_streak_won_has_four_games(self, by_name):
    ...
    def test_fourward_thinking_game_count_in_range(self, by_name):
    ...
    def test_fourward_thinking_won_has_four_games(self, by_name):
...
class TestCoopRollGameCounts:
    def test_destiny_alignment_has_two_games(self, by_name):
    ...
    def test_soul_mates_has_one_game(self, by_name):
    ...
    def test_teamwork_makes_the_dream_work_has_four_games(self, by_name):
...
class TestCrossRollConsistency:
    def test_co_op_rolls_have_partner_id(self, by_name):
        co_op_names = (
            "Destiny Alignment",
            "Soul Mates",
    ...
    def test_solo_rolls_have_no_partner_id(self, by_name):
    ...
    def test_active_multi_stage_rolls_have_valid_stage_count(self, by_name):
